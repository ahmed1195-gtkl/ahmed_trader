...
const resources = {
  en: {
    translation: {
      ...
      "aibot.risk.title": "Risk Management",
      "aibot.risk.positionSize": "Recommended Position Size",
      "aibot.risk.ratio": "Risk/Reward Ratio",
      "aibot.tech.rsi": "RSI Indicator",
      "aibot.tech.trend": "Market Trend",
      "aibot.rl.learning": "AI Learning Mode",
      "aibot.rl.status": "Brain Status: Adapting",
  ...
  ar: {
    translation: {
      ...
      "aibot.classic.bear": "اختراق نمط القمة المزدوجة مع زخم بيع قوي.",
      "aibot.risk.title": "إدارة المخاطر",
      "aibot.risk.positionSize": "حجم الصفقة الموصى به",
      "aibot.risk.ratio": "نسبة المخاطرة/العائد",
      "aibot.tech.rsi": "مؤشر RSI",
      "aibot.tech.trend": "اتجاه السوق",
      "aibot.rl.learning": "وضع التعلم الذكي",
      "aibot.rl.status": "حالة الدماغ: يتكيف حالياً",
  ...
  fr: {
    translation: {
      ...
      "aibot.classic.bull": "Cassure d'une ligne de tendance descendante avec un retest réussi.",      "aibot.classic.bear": "Cassure d'une figure en double sommet avec un fort momentum vendeur.",
      "aibot.risk.title": "Gestion des Risques",
      "aibot.risk.positionSize": "Taille de Position Recommandée",
      "aibot.risk.ratio": "Ratio Risque/Récompense",
      "aibot.tech.rsi": "Indicateur RSI",
      "aibot.tech.trend": "Tendance du Marché",
      "aibot.rl.learning": "Mode Apprentissage IA",
      "aibot.rl.status": "État du Cerveau : Adaptation",
    }
  }
};
