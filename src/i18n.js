...
const resources = {
  ...
  ar: {
    translation: {
      ...
      "auth.accountSuspended": "تم تعليق حسابك لأسباب أمنية. لا يمكنك التسجيل بنفس البريد الإلكتروني مرة أخرى.",
      ...
      "feed.comment": "تعليق",
      "feed.post": "نشر",
      "feed.noPosts": "لا توجد منشورات بعد."      "feed.adminOnly": "ميزة خاصة بالأدمن فقط",
