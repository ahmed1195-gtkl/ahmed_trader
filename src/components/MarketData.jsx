...
const MarketData = () => {
  ...
  const fetchMarketData = async () => {
    ...
    try {
      ...
      const response = await fetch('https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=bitcoin,ethereum,tether,binancecoin,solana,ripple,cardano,avalanche-2,dogecoin,polkadot&order=market_cap_desc&per_page=10&page=1&sparkline=false');
  ...
  return (
    <div className="w-full bg-black/60 backdrop-blur-xl border-y border-yellow-500/20 py-3 md:py-4 overflow-hidden relative z-20">
