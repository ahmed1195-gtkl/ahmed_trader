      ...
      <section className="relative pt-24 pb-12 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <motion.button
            ...
            className={`flex items-center gap-2 text-muted-foreground hover:text-amber-500 transition-colors mb-8`}
          >
        ...
        <div className="space-y-3">
          {lessons.map((lesson, index) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 glass-card border border-border hover:border-amber-500/30 transition-all duration-300 p-4 sm:p-5">
                  {/* Lesson number */}
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-sm sm:text-base font-semibold text-foreground group-hover:text-amber-400 transition-colors truncate">
                      {lessonData?.title}
                    </h3>
                  ...
                  {/* Arrow */}
                  <ChevronLeft className={`flex-shrink-0 w-5 h-5 text-muted-foreground group-hover:text-amber-500 transition-colors ${isRTL ? '' : 'rotate-180'}`} />
                </div>
              </motion.div>
            );
          })}
