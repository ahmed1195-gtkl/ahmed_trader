    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center p-6">
        <motion.div
          ...
          className="max-w-md w-full bg-zinc-900 border border-red-500/20 rounded-3xl p-8 text-center"
        >
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-b border-white/10 p-8">
          ...
          <h1 className="text-4xl font-black text-white uppercase text-center mb-2">
