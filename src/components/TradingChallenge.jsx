              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-gray-500 uppercase tracking-wider">
                      {i18n.language === 'ar' ? 'رسوم الاشتراك' : i18n.language === 'fr' ? 'Frais' : 'Entry Fee'}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center justify-between py-2 border-b border-white/5">
                    ...
                    <span className="text-sm font-bold text-green-500">+{level.profitTarget}%</span>
                  </div>
                  
                  <div className="flex items-center justify-between py-2 border-b border-white/5">
                    <span className="text-sm text-gray-500">Max Drawdown</span>
                    <span className="text-sm font-bold text-red-500">{level.maxDrawdown}%</span>
                  </div>
